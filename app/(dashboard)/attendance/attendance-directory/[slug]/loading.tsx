  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <Skeleton className="bg-muted h-4 w-32 animate-pulse rounded" />
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Skeleton className="bg-muted h-10 w-10 shrink-0 animate-pulse rounded" />
            <div className="space-y-2">
              <Skeleton className="bg-muted h-6 w-40 animate-pulse rounded" />
              <Skeleton className="bg-muted h-4 w-32 animate-pulse rounded" />
            </div>
          </div>
          <Skeleton className="bg-muted h-9 w-44 animate-pulse rounded" />
        </div>
      </div>
