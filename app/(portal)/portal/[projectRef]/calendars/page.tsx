...
import { PortalCalendars } from "@/features/client-portal"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Calendars",
  description: "Content calendars the team has shared with you.",
}

export default async function PortalCalendarsPage({
  params,
}: {
