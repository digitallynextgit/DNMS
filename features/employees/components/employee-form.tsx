        ...
        return (
          <div key={step.number} className="flex items-center">
            <div className="flex flex-col items-center gap-1.5">
              <div
                className={cn(
                  "flex h-8 w-8 items-center justify-center rounded-sm text-sm font-semibold transition-all",
                ...
                {(watchedValues.onProbation ?? true) && (
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <FormField label="Probation Ends">
                      <div className="border-input bg-background text-muted-foreground flex h-10 items-center rounded-sm border px-3 text-sm">
                        {probationHint}
                      </div>
                    </FormField>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                {existingDocs.map((doc) => (
                  <div
                    key={doc.id}
                    className="bg-muted/30 hover:bg-muted/50 flex items-center justify-between rounded-sm border px-4 py-3 transition-colors"
                  >
            ...
            <CardContent className="space-y-4">
              {pendingDocs.length === 0 ? (
                <label
                  ...
                  className="border-border hover:border-foreground/40 hover:bg-muted/30 flex cursor-pointer flex-col items-center justify-center rounded-sm border border-dashed py-12 transition-colors"
                >
