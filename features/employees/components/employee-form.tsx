      ...
      {currentStep === 2 && (
        <Card>
          ...
          <CardContent className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            {isProbationAdmin && (
              <div className="border-border bg-muted/30 space-y-3 rounded-[2px] border p-4 sm:col-span-2">
                ...
                {(watchedValues.onProbation ?? true) && (
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <FormField label="Probation Ends">
                      <div className="border-input bg-background text-muted-foreground flex h-10 items-center rounded-[2px] border px-3 text-sm">
                        {probationHint}
                      </div>
                    </FormField>
                  </div>
                    ...
                    <div className="max-h-64 overflow-y-auto p-1">
                      {employeeCodes.length === 0 ? (
                        ...
                        employeeCodes.map((e) => (
                          <div
                            key={e.id}
                            className="flex items-center justify-between gap-2 rounded-[2px] px-2 py-1.5 text-sm"
                          >
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                {existingDocs.map((doc) => (
                  <div
                    key={doc.id}
                    className="bg-muted/30 hover:bg-muted/50 flex items-center justify-between rounded-[2px] border px-4 py-3 transition-colors"
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="bg-background flex h-9 w-9 shrink-0 items-center justify-center rounded-[2px] border">
            ...
            <CardContent className="space-y-4">
              {pendingDocs.length === 0 ? (
                <label
                  ...
                  className="border-border hover:border-foreground/40 hover:bg-muted/30 flex cursor-pointer flex-col items-center justify-center rounded-[2px] border border-dashed py-12 transition-colors"
                >
                ...
                <div className="space-y-3">
                  {pendingDocs.map((doc) => (
                    <div key={doc.uid} className="bg-muted/20 space-y-4 rounded-[2px] border p-4">
