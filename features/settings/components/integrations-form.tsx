    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between gap-3 space-y-0">
        <div className="flex min-w-0 items-center gap-2">
          ...
          {groupRequired && (
            <span className="bg-muted text-muted-foreground shrink-0 rounded-sm px-1.5 py-0.5 text-[10px] font-medium tracking-wide uppercase">
              Required
            </span>
          )}
          {complete ? (
...
function FieldInput({
  ...
  if (field.type === "boolean") {
    return (
      <div className="flex items-center justify-between rounded-sm border px-3 py-2.5 sm:col-span-2">
