  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "text-muted-foreground w-8 rounded-lg text-[0.8rem] font-normal",
        ...
        selected:
          "[&>button]:bg-primary [&>button]:text-primary-foreground [&>button:hover]:bg-primary [&>button:hover]:text-primary-foreground rounded-lg",
        today: "[&>button]:bg-accent [&>button]:text-accent-foreground rounded-lg",
