...
function ThemeCard({
  ...
  return (
    <button
      ...
      className={cn(
        "group relative flex flex-col gap-2 rounded-sm border p-3 text-left transition-shadow hover:shadow-md focus-visible:ring-2 focus-visible:outline-none",
        selected
    ...
    >
      ...
      >
        ...
        <div className="relative flex gap-1.5">
          ...
          />
          <span
            className="h-6 w-6 rounded-sm border border-white/20 shadow-sm"
